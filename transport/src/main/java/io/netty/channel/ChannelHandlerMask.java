...
final class ChannelHandlerMask {
     ...
     * 返回handlerType类，不能跳过的方法的mask值，值在{@link io.netty.channel.ChannelHandlerMask}
     */
     ...
     * 根据给定的ChannelHandler class类型，计算mask值
     */
    private static int mask0(Class<? extends ChannelHandler> handlerType) {
        ...
        try {
            ...
            //  isAssignableFrom 和 instanceof 刚好相反
    ...
    /**
     * 判断ChannelHandler的方法名为methodName的方法，是否有注解@Skip
     *
     * @param handlerType ChannelHandler的class
