...
public class NioEventLoopGroup extends MultithreadEventLoopGroup {
    ...
    public NioEventLoopGroup(int nThreads, Executor executor) {
        // SelectorProvider传递的是jdk的SelectorProvider.provider()
    ...
    public NioEventLoopGroup(
        ...
        // SelectStrategyFactory传递的是DefaultSelectStrategyFactory.INSTANCE
        this(nThreads, executor, selectorProvider, DefaultSelectStrategyFactory.INSTANCE);
    }

    public NioEventLoopGroup(int nThreads, Executor executor, final SelectorProvider selectorProvider,
                             final SelectStrategyFactory selectStrategyFactory) {
        // 调用父类构造器，最后一个参数传递了RejectedExecutionHandlers.reject()
    ...
    /**
     * 在{@link  MultithreadEventExecutorGroup#MultithreadEventExecutorGroup(int, java.util.concurrent.Executor, io.netty.util.concurrent.EventExecutorChooserFactory, java.lang.Object...)}
     * 中被调用
     *
    ...
    protected EventLoop newChild(Executor executor, Object... args) throws Exception {
        // 获取参数SelectorProvider,默认SelectorProvider.provider()
        SelectorProvider selectorProvider = (SelectorProvider) args[0];
        // 获取SelectStrategyFactory,默认DefaultSelectStrategyFactory.INSTANCE
        SelectStrategyFactory selectStrategyFactory = (SelectStrategyFactory) args[1];
        // 获取RejectedExecutionHandler，默认RejectedExecutionHandlers.reject()
        RejectedExecutionHandler rejectedExecutionHandler = (RejectedExecutionHandler) args[2];
        EventLoopTaskQueueFactory taskQueueFactory = null;
        EventLoopTaskQueueFactory tailTaskQueueFactory = null;

        // 下面两个参数，默认构造器初始化的时候，没传
