...
public abstract class AbstractNioChannel extends AbstractChannel {
    ...
    /**
     * {@link AbstractNioChannel#doRegister()}中初始化
     */
    ...
    protected AbstractNioChannel(Channel parent, SelectableChannel ch, int readInterestOp) {
        super(parent);
        // 把ServerSocketChannel保存起来
        this.ch = ch;
        // 注册的SelectionKey.OP_ACCEPT
    ...
    protected abstract class AbstractNioUnsafe extends AbstractUnsafe implements NioUnsafe {
        ...
        /**
         * 在{@link NioEventLoop#processSelectedKey(java.nio.channels.SelectionKey, io.netty.channel.nio.AbstractNioChannel)}
         * 中被调用
         */
        @Override
    ...
    /**
     * {@link AbstractUnsafe#register0(io.netty.channel.ChannelPromise)}调用
     *
     * @throws Exception
     */
    @Override
    ...
    /**
     * 在{@link AbstractNioMessageChannel#doBeginRead()}中被调用
     *
     * @throws Exception
     */
    @Override
