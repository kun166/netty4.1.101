...
public abstract class AbstractChannel extends DefaultAttributeMap implements Channel {
    ...
    /**
     * {@io.netty.channel.socket.nio.NioServerSocketChannel}中，在
     * {@link ServerBootstrap#init(io.netty.channel.Channel)}方法中,添加了
    ...
    /**
     * 在{@link AbstractUnsafe#register(io.netty.channel.EventLoop, io.netty.channel.ChannelPromise)}
     * 设置的
    ...
    protected abstract class AbstractUnsafe implements Unsafe {
         ...
         * {@link SingleThreadEventLoop#register(io.netty.channel.ChannelPromise)}
         *
         * @param eventLoop
         * @param promise
         */
        ...
        /**
         * {@link AbstractUnsafe#register(io.netty.channel.EventLoop, io.netty.channel.ChannelPromise)}调用
         *
         * @param promise
         */
        private void register0(ChannelPromise promise) {
            try {
                ...
                // 传入的是DefaultChannelPromise
                if (!promise.setUncancellable() || !ensureOpen(promise)) {
                    return;
                }
                boolean firstRegistration = neverRegistered;
                /**
                 * 这个地方调用了{@link AbstractNioChannel#doRegister()}
                 */
                doRegister();
                ...
                // 特别注意这个方法，里面调用了promise.trySuccess()，设置了promise的result的值
                safeSetSuccess(promise);
                // 调用fireChannelRegistered方法
        ...
        /**
         * 在{@link DefaultChannelPipeline.HeadContext#bind(io.netty.channel.ChannelHandlerContext, java.net.SocketAddress, io.netty.channel.ChannelPromise)}
         * 里被调用
         *
         * @param localAddress
         * @param promise
         ...
         * 在{@link AbstractUnsafe#register0(io.netty.channel.ChannelPromise)}被调用
         * 需要特别注意promise.trySuccess()，设置了promise的value值
         */
     ...
     * 在{@link AbstractUnsafe#beginRead()}中被调用
     */
