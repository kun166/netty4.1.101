...
public abstract class SingleThreadEventExecutor extends AbstractScheduledEventExecutor implements OrderedEventExecutor {
    ...
    /**
     * 在{@link io.netty.channel.nio.NioEventLoop}中传递了false
     */
    ...
    protected SingleThreadEventExecutor(EventExecutorGroup parent, Executor executor,
        ...
        /**
         * 装饰者模式
         * 每次执行任务的还是这个executor,但是在executor执行任务期间,调用{@link ThreadExecutorMap#currentExecutor()}会返回本实例对象
         * 注意:{@link ThreadExecutorMap}方法都是静态的，但是它是和线程绑定的
         */
        this.executor = ThreadExecutorMap.apply(executor, this);
     ...
     * <p>
     * {@link io.netty.channel.nio.NioEventLoop#run()}中调用
     */
    ...
    private void doStartThread() {
        ...
        executor.execute(new Runnable() {
            ...
            public void run() {
                 ...
                 * 设置线程为当前线程
                 * 当前线程是怎么来的？
                 * {@link MultithreadEventExecutorGroup#MultithreadEventExecutorGroup(int, java.util.concurrent.Executor, io.netty.util.concurrent.EventExecutorChooserFactory, java.lang.Object...)}
                 * 最终是{@link DefaultThreadFactory#newThread(java.lang.Runnable, java.lang.String)}
                 * 这个方法每调用一次,Thread.currentThread()就变换一次
                 * 当然这个方法按常规只能启动一次
                 */
